...
export const ComponentReviewCard = ({
  ...
  const screenshotPath = `${siteConfig.imageBasePath}${path}${screenshot}`;
      ...
      <div className="flex flex-col gap-4">
        <div className="relative overflow-hidden rounded-[10px]">
          <img
            src={screenshotPath}
            alt={`${name}-screenshot`}
            className="w-full h-[145px] transition-transform duration-500 ease-in-out group-hover:scale-200"
          />
        </div>
